...
function setup()
 {
    ...
    tree = createSprite(700,330,20,20);
  ...
  stone = new Stone(200,200,70);
	...
	mango1 = new Mango(700,220,60);
	mango2 = new Mango(760,200,60);
	mango3 = new Mango(800,100,60);
	mango4 = new Mango(605,150,60);
	mango5 = new Mango(900,170,60);
	mango6 = new Mango(870,250,60);
	mango7 = new Mango(550,250,60);
